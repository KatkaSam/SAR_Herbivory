...
#chewing_herbivory = average % of herbivory by chewers
#mining_herbivory = average % of herbivory by miners
#leaf_area = average size of a leaf
#total_pct_direct
#total_herbivory = sum of the herbivory by chewers and miners in % 
#total_pct_counted = sum of the herbivory by chewers and miners in proportions - used for analyses
...
TH1 <- herbivory_traits[ , -c(2:13, 27:28, 31:33)]
summary(TH1)
TH2 <- TH1 [ , -c(1, 5, 6)]
summary(TH2)
...
TH2$total_pct_counted<-scale(TH2$total_pct_counted)
...
model_polt_5<-corrplot(herb, type="upper", method="color",
...
plot1<-ggscatter(herbivory_traits, y = "chewing_herbivory", x = "BiteSizeIndex", 
          ...
          repel = TRUE, label.select = c("CEL_AFR", "DOM_ROT", "COR_CAF", "DRY_ARG", "RAW_LUC", "ECU_NAT",
                                         "BER_ZEY", "ZIZ_MUC", "SCO_ZEY", "GRE_FLA","GYM_MAR", "TAR_PAV", "SCL_BIR",
                                         "DIC_CIN", "DIO_DIC", "BRA_ILL", "EUC_RAC", "EUC_NAT", "ACA_CAF"), 
